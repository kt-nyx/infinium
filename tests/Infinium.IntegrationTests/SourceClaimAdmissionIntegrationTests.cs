...
public sealed class SourceClaimAdmissionIntegrationTests
{
    ...
    public void SourceClaimAdmissionExecutesRegisteredPackagesWithoutTransport()
    {
        ...
        {
            (SourceClaimExecutionInput input, SourceClaimRetainedTranscript[] transcripts) = Load(package);
    ...
    internal static (SourceClaimExecutionInput Input, SourceClaimRetainedTranscript[] Transcripts) Load(string package)
    {
