...
public sealed class M1Slice6FreshAuthorityVersionTests
{
    ...
    public void FreshEvidenceSchemasAreVersionCoupled()
    {
        ...
        Assert.AreEqual("infinium.m1-s6.successor-attempt-evidence/v2",
            M1Slice6AuthorityContracts.StageEvidenceSchema(M1Slice6AuthorityContractVersion.SuccessorV5));
        Assert.AreEqual("infinium.m1-s6.successor-attempt-evidence/v3",
            M1Slice6AuthorityContracts.StageEvidenceSchema(M1Slice6AuthorityContractVersion.SuccessorV6));
        ...
        Assert.AreEqual("infinium.m1-s6.successor-composed-evidence/v2",
            M1Slice6AuthorityContracts.ComposedEvidenceSchema(M1Slice6AuthorityContractVersion.SuccessorV6));
