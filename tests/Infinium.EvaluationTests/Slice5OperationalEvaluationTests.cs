...
[TestClass]
public sealed class Slice5OperationalEvaluationTests
{
    [TestMethod]
    [TestCategory("M1Evaluation")]
    public void Slice5OperationalFixtureRegistryIsFrozenClosedAndAnswerIsolated()
    {
    ...
    public void CleanIncrementalReplayFixtureInvalidatesOnlyTheChangedDependencyClosure()
    {
        ...
        JsonElement expectation = ExpectedCase(expected.RootElement, "WP5-LANTERN-REPLAY-D02")
    ...
    private static string FixtureRoot() => Path.Combine(
        FindRepositoryRoot(), "docs", "evaluation", "fixtures", "m1-slice5-wp5-operational-cases-v1");
