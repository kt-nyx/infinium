...
[TestClass]
public sealed class AnalysisStateModelTests
{
    ...
    public void AnalysisStateModelRequiresOneDecisionPerPopulationMember()
    {
        CandidateAnalysisContract value = EmptyCandidates() with { PopulationDenominator = 1 };
        Assert.ThrowsExactly<InvalidOperationException>(() => CandidateAnalysisContractInvariants.Validate(value));
    }

    [TestMethod]
    [TestCategory("Unit")]
    [TestProperty("Category", "Unit")]
    public void AnalysisStateModelRejectsScoreDependentMandatoryAdmission()
    {
    ...
    [TestCategory("Unit")]
    [TestProperty("Category", "Unit")]
    public void AnalysisStateModelRequiresUniquePopulationDecisionsAndOneCandidatePerAdmission()
    {
        ...
        Assert.ThrowsExactly<InvalidOperationException>(() => CandidateAnalysisContractInvariants.Validate(duplicatedPopulation));
        ...
        Assert.ThrowsExactly<InvalidOperationException>(() => CandidateAnalysisContractInvariants.Validate(missingCandidate));

        CandidateHypothesisContract hypothesis = new(
            Id("hypothesis-1"), Id("candidate-1"), AnalysisResultState.Present,
        ...
        CandidateAnalysisEntryContract candidate = new(
            Id("candidate-1"), first.DecisionId, AnalysisResultState.Present, "causal explanation",
        ...
        CandidateAnalysisContractInvariants.Validate(valid);
    }

    [TestMethod]
    [TestCategory("Unit")]
    [TestProperty("Category", "Unit")]
    public void AnalysisStateModelRejectsSpeculativeFindingAndReadinessAffectingLead()
    {
        ...
        Assert.ThrowsExactly<InvalidOperationException>(() => FindingCaseContractInvariants.Validate(speculative));

        AnalysisCaseContract lead = new(
        ...
        Assert.ThrowsExactly<InvalidOperationException>(() => FindingCaseContractInvariants.Validate(readinessLead));
    }

    [TestMethod]
    [TestCategory("Unit")]
    [TestProperty("Category", "Unit")]
    public void AnalysisStateModelCompleteReplayCannotHideMissingDependenciesButPreservesSeparateCoverageGaps()
    {
        ...
        Assert.ThrowsExactly<InvalidOperationException>(() => AnalysisReplayContractInvariants.Validate(invalid));

        AnalysisReplayContractInvariants.Validate(invalid with { MissingDependencyIds = [] });
        Assert.AreEqual(
    ...
    [TestCategory("Unit")]
    [TestProperty("Category", "Unit")]
    public void AnalysisStateModelRequiresPriorIdentityForEveryReplayModeThatUsesPriorState()
    {
        AnalysisReplayContract retainedWithoutPrior = new(
            ...
            [], [], [], [], [], false, null);
        Assert.ThrowsExactly<InvalidOperationException>(() => AnalysisReplayContractInvariants.Validate(retainedWithoutPrior));

        AnalysisExecutionInputContract retainedExecutionWithoutPrior = ExecutionInput(ReplayMode.RetainedDownstreamReplay, null);
        Assert.ThrowsExactly<InvalidOperationException>(() => AnalysisExecutionContractInvariants.Validate(retainedExecutionWithoutPrior));

        AnalysisExecutionContractInvariants.Validate(ExecutionInput(ReplayMode.RetainedDownstreamReplay, Id("prior-run")));
    }

    [TestMethod]
    [TestCategory("Unit")]
    [TestProperty("Category", "Unit")]
    public void AnalysisStateModelRequiresUniqueApplicationsBoundToExistingClaims()
    {
        ...
        DocumentationEvidenceContractInvariants.Validate(valid);

        Assert.ThrowsExactly<InvalidOperationException>(() =>
            DocumentationEvidenceContractInvariants.Validate(DocumentationWithApplications([
                application,
        ...
        IReadOnlyList<ClaimApplicationContract> applications)
    {
        DocumentationEvidenceContract value = new(
            ...
            [
                new(Id("passage-1"), Id("revision-1"), 0, 1, Fingerprint, AnalysisResultState.Present),
            ],
            [
                new(
