...
[TestClass]
public sealed class AnalysisOutputQueryContractTests
{
    [TestMethod]
    [TestCategory("Contract")]
    public void AnalysisOutputHumanAndJsonContractsCarryEquivalentQualifiedSemantics()
    {
    ...
    [TestMethod]
    [TestCategory("Contract")]
    public void AnalysisQueryProtocolIsTypedBoundedAndCarriesNoDatabaseSurface()
    {
    ...
    [TestMethod]
    [TestCategory("Contract")]
    public void AnalysisOutputAssignmentRejectsExternalUseAndEveryExceededBound()
    {
