...
public sealed class AnalysisContractTests
{
    ...
    public void CaseGroupingPublicationRejectsMissingCausalProofAndAnswerBearingInput()
    {
        FindingCaseInputContract input = CreateFindingCaseInput();
        FindingCaseContract output = FindingCasePipeline.Execute(input);
        AnalysisCaseContract invalidCase = output.Cases.Single() with { CauseProofEvidenceIds = [] };
    ...
    [TestCategory("Contract")]
    [TestProperty("Category", "Contract")]
    public void AnalysisContractPayloadsRoundTripThroughStrictEmbeddedSchemas()
    {
    ...
    public void CandidateContractRejectsDanglingMissingMisdirectedAndSemanticallyUnboundReferences()
    {
        ...
        CandidateGapContract falseGap = new(
            ...
            AnalysisResultState.Missing, "claimed missing witness", "required witness");
        AssertRejected(RecountAndIdentify(valid with
        {
            Gaps = [falseGap],
    ...
    [TestProperty("Category", "Contract")]
    [TestProperty("Category", "Security")]
    public void AnalysisExecutionInputRejectsAnswersUnknownPropertiesAndDuplicateProperties()
    {
    ...
    [TestCategory("Contract")]
    [TestProperty("Category", "Contract")]
    public void AnalysisExecutionInputRepresentsFixedStressPopulationsExactly()
    {
    ...
    [TestCategory("Contract")]
    [TestProperty("Category", "Contract")]
    public void AnalysisReplayModesBindPriorRunIdentityExactly()
    {
    ...
    [TestCategory("Contract")]
    [TestProperty("Category", "Contract")]
    public void AnalysisCleanReplayCanCloseWithoutComparedRunIdentity()
    {
        AnalysisReplayContract replay = new(
            ContractConstants.AnalysisReplaySchemaId,
            Version(),
    ...
    private static CandidateAnalysisContract CreateNonEmptyCandidateAnalysis()
    {
        ...
        CandidateAnalysisEntryContract candidate = new(
            candidateId, decisionId, AnalysisResultState.Present,
        ...
        CandidateHypothesisContract hypothesis = new(
            hypothesisId, candidateId, AnalysisResultState.Present,
