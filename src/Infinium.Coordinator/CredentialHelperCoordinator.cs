...
public sealed class CredentialHelperCoordinator
{
            ...
            CancellationToken cancellationToken)
    {
            ...
            && current.LifecycleState != "replacing")
        {
            current = store.ApplyCredentialTransition(new(
                ...
                "replacing",
                "replacing",
                current.CapabilitySnapshotId ?? OpenAiProviderProfileCatalog.Capability.Identity.Value,
        ...
        CredentialTransitionRequest transition = new(
            ...
            completedState,
            completedState,
            deleted ? null : current.CapabilitySnapshotId ?? OpenAiProviderProfileCatalog.Capability.Identity.Value,
        ...
        bool unavailable)
    {
        CredentialProfileProjection pendingCleanup = store.ApplyCredentialTransition(new(
            ...
            "delete-pending",
            "delete-pending",
            predecessor.CapabilitySnapshotId ?? OpenAiProviderProfileCatalog.Capability.Identity.Value,
        ...
        CancellationToken cancellationToken)
    {
        ...
        ProviderDispatchGateReceipt finalGate = new ProviderUsageAccounting(store).FinalGate(gate);
