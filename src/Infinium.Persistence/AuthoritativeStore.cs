...
public sealed class AuthoritativeStore : IDisposable
{
    ...
    private const string SchemaV4 =
        ...
        CREATE TABLE evidence_application_links(
            ...
            created_at TEXT NOT NULL,
            UNIQUE(evidence_revision_id, run_id)
        ) STRICT;
        ...
        CREATE TABLE taxonomy_assignments(
            ...
            subject_kind TEXT NOT NULL CHECK(subject_kind IN (
                'documentation-revision','evidence-revision','candidate','hypothesis',
                'finding-occurrence','case-occurrence')),
            subject_id TEXT NOT NULL,
            taxonomy_id TEXT NOT NULL,
            taxonomy_version TEXT NOT NULL,
            axis TEXT NOT NULL CHECK(axis IN (
                'purpose','surface','area','consequence','extent')),
            taxonomy_code TEXT,
            applicability_state TEXT NOT NULL CHECK(applicability_state IN (
        ...
        CREATE TABLE analysis_dependency_edges(
            ...
            from_kind TEXT NOT NULL CHECK(from_kind IN (
                'documentation-revision','passage','evidence-revision','candidate-decision',
            ...
            edge_kind TEXT NOT NULL CHECK(edge_kind IN (
                'derived-from','supports','contradicts','applies','depends-on','reuses',
