...
{
    public const int CurrentSchemaVersion = ApplicationSetupPersistenceDeclarations.SchemaVersion;
    public const string CurrentStorageContractVersion = ApplicationSetupPersistenceDeclarations.StorageContractVersion;
