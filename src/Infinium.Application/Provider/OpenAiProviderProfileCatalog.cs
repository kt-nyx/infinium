...
public static class OpenAiProviderProfileCatalog
{
        ...
        ProviderFiniteLimitsContract limits)
    {
        ...
        if (result > limits.MaximumCalculatedNanoUsd)
        {
            throw new InvalidOperationException(
                "The current provider price catalog exceeds the operation's configured nano-USD hard limit.");
        }
        return result;
    }

    public static ProviderCatalogProjection CreateNonLiveProjection(UtcTimestamp observedAt)
    {
    ...
    {
        const string identity = "openai-gpt-5.6-sol-capability-2026-08-10";
    ...
    {
        const string identity = "openai-gpt-5.6-sol-price-2026-08-10";
        ProviderPriceRuleContract[] rules =
        [
            new(new OpaqueId("openai-sol-standard-input"), "openai", "gpt-5.6-sol", "default",
                "standard-under-272k", "ordinary-input", "input", "none", "global", "USD",
                OrdinaryInputNanoUsdPerToken, 1, PriceRevision),
            new(new OpaqueId("openai-sol-standard-output"), "openai", "gpt-5.6-sol", "default",
                "standard-under-272k", "none", "output", "none", "global", "USD",
                OutputNanoUsdPerToken, 1, PriceRevision),
            new(new OpaqueId("openai-sol-reasoning-output"), "openai", "gpt-5.6-sol", "default",
                "standard-under-272k", "none", "reasoning", "none", "global", "USD",
                OutputNanoUsdPerToken, 1, PriceRevision),
            new(new OpaqueId("openai-sol-cache-read"), "openai", "gpt-5.6-sol", "default",
                "standard-under-272k", "cache-read", "input", "none", "global", "USD",
                CacheReadNanoUsdPerToken, 1, PriceRevision),
            new(new OpaqueId("openai-sol-cache-write"), "openai", "gpt-5.6-sol", "default",
