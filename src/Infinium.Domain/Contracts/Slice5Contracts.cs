...
public static class Slice5ContractInvariants
{
    ...
    public static void Validate(FindingCaseContract value)
    {
        ...
        {
            throw new InvalidOperationException("WP4 publication is informational and must carry the exact no-safety-claim boundary.");
        }
        ...
        {
            Slice5ReconciliationContract? assessment = lineage.ReconciliationAssessmentId is null ? null
