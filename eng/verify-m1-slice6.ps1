...
function Invoke-CredentialNativeRecoveryGate {
    ...
    if($m.manifest_id-ne'infinium.m1-s6.wp4.credential-native-recovery/6a1e3f05-2189-46f8-8dff-48edb40496dc'-or$m.status-ne'ready-for-owner-acceptance'){throw 'Recovery identity is not executable.'}
