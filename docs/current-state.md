...
| Next eligible action | Freeze and rebind the exact campaign candidate after committed-rehearsal correction, then rerun the complete non-live floor and obtain fresh independent review. Credential execution is ineligible before exact campaign review, admission, and credential-rollover validation. |
