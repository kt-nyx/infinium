...
| Next gate | Materialize and independently review the exact C2B WP9 qualification request and runtime authority against the accepted C2A predecessor, then execute it once only if every admission check passes. |
