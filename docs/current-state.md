...
Status: Implementation-active; owner credential action required
Disposition: The original C2B campaign and v2 successor ledger are immutable; the hard-budget continuation reached the provider, and independently accepted WP9 ordinal-8 evidence proves that the retained stored credential is externally invalid or revoked
...
| Current authorized work | The immutable v2 predecessor remains sequence 8, SHA-256 `db30e1d5281b2127a807d7bfc02b5608e5d80b4321b397e933b78a225fbe8aa8`. Hard-budget ledger v3 has current tip sequence 39, event `b5292326a65791731614a6ab75a0b838de121ea721d01d5489f4c2897f88dcc0`. Eight WP9 possible starts are conservatively retained; successor unresolved exposure is USD 0.77056, total Slice 6 committed exposure is USD 0.91056, outstanding reservation is zero, and USD 9.08944 remains under the hard limit. WP9 has no structurally valid authoritative result. |
| Next gate | Do not make another provider attempt with the retained credential. WP9 ordinal 8 reached the provider once and received exact HTTP 401 `invalid_api_key`; immutable evidence SHA-256 `ea299565dc60604afa2bef9ae8f54205e591c78c24f1b0a746bdc2149c60604c` is independently accepted, and offline diagnosis found no local transport, target, header, whitespace, credential-lifecycle, or isolation defect. The owner must authorize replacement/re-enrollment of the externally invalid or revoked credential, because active credential-access v2 explicitly prohibits replacement. A replacement must use a fresh credential authority and fresh attempt identities while preserving ledger v3 sequence 39 and every retained artifact. |
