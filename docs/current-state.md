...
| Next eligible action | Freeze and bind the canonical ordinary-build revision correction, prove repeated explicit and ordinary builds reproduce the complete closure, then rerun the complete floor and fresh independent review. Credential execution remains ineligible. |
...
unknown replacement bytes. Current authority is correction and non-live
reverification only.
