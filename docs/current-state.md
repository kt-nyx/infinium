...
| Next eligible action | Run the complete non-live floor and fresh independent security, semantics, and diff review against the exact four-document binding successor. Credential execution remains ineligible. |
