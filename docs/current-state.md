...
| Next eligible action | Finish the bounded correction, freeze and bind a replacement candidate, then run the complete non-live floor and fresh independent review. Credential execution remains ineligible. |
...
Current authority is correction, non-live reverification, and fresh review of
the finite-campaign implementation only. The separately committed zero-effect
