...
| Next eligible action | Preserve the exact review-state phrase during formatting, refreeze and rebind, then restart the complete non-live floor and fresh independent review. Credential execution remains ineligible. |
