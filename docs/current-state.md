...
| Current authorized work | `M1/S6/WP9` bounded non-effectful owner-acceptance closeout correction and reverification only. The exact owner marker at `b64353f0f5a843fce7c1c395a606c47e62d274ee` is retained as superseded historical evidence and grants no current owner or execution authority. Owner acceptance and WP9 execution are ineligible. |
...
The B17 owner transition and B18 replacement review fixtures exposed missing
identity isolation for append-only historical owner markers. Every historical
marker remains retained, but only an exact current manifest ID-and-SHA marker
may affect current admission. Correction and complete non-live reverification
are active; owner acceptance and execution are ineligible. No WP8 template,
