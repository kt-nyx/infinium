...
| Next gate | Bind the accepted v6/v3 implementation and sequence-9 authority bytes in Git, then derive entirely fresh WP9 ordinal-3 stage-v6/runtime-v3 identities from the new ledger tip and independently review them. The expired pre-effect attempt-3 directory remains retained and cannot be reused. No provider call is admitted before exact runtime review. |
