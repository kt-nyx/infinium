...
| Next eligible action | Freeze a replacement close-ready source, materialize its exact clean four-document binding successor, then run the complete non-live floor and fresh independent security, semantics, and diff review. Credential execution remains ineligible. |
