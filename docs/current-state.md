...
Status: Implementation-active; generation-2 credential rollover admitted
Disposition: The invalid generation-1 credential and campaign-v6 path are immutable historical evidence; verified generation 2 is active under campaign v7 and the single ledger-v4 continuation
...
| Current authorized work | The immutable v2 predecessor remains sequence 8 and hard-budget ledger v3 is frozen at sequence 39/event `b5292326a65791731614a6ab75a0b838de121ea721d01d5489f4c2897f88dcc0`. Independently accepted replacement evidence activates verified credential generation 2. Campaign v7, credential-access v3, and profile v5 admit one single-writer ledger-v4 continuation; its current tip is sequence 40/event `66544b69df2b21ae5b8f601f26e10deb4fc685c68e03cc8027586d66f330fdb7`, whole-file SHA-256 `af3ab3202514cf26695655710b550661ad7b7356fed246019f532a7227ede061`. Eight WP9 possible starts and USD 0.77056 unresolved successor exposure are preserved; total committed exposure is USD 0.91056, outstanding reservation is zero, and USD 9.08944 remains under the hard limit. WP9 has no structurally valid authoritative result. |
| Next gate | Materialize a wholly fresh WP9 ordinal-9 stage/runtime package against ledger-v4 sequence 40 and current Release apphosts, obtain independent runtime-candidate review, then permit exactly one sequential provider start. Generation 1, credential-access v2, campaign v6, and ledger v3 are historical-only and cannot authorize another effect. |
| Later packages | C2C/WP10 remains unopened until WP9 obtains its first structurally valid accepted result under fresh credential authority. C2D/WP11 and effect-free C3 remain unopened. After credential replacement, each attempt still requires fresh exact stage/runtime authority, sequential durable admission, no retry, and first-valid latching. No private fixture, archive, push, or Slice 7 work is authorized. |
...
- [Active generation-2 successor credential read-only access authority v3](plans/milestones/m1/slices/s6/m1-slice6-successor-credential-access.v3.json)
- [Active generation-2 successor campaign authorization v7](plans/milestones/m1/slices/s6/m1-slice6-successor-campaign-authorization.v7.json)
- [Active generation-2 production profile v5](plans/milestones/m1/slices/s6/wp9-production-profile-authorization.v5.json)
