...
| Next eligible action | Refreeze the state-aware committed rehearsal, bind its exact clean four-document campaign successor, then rerun the complete non-live floor and fresh independent review. Credential execution remains ineligible. |
