...
| Next eligible action | Refreeze the repository-formatted candidate, bind its exact clean four-document campaign successor, then rerun the complete non-live floor and fresh independent review. Credential execution remains ineligible. |
...
unknown replacement bytes. Binding `6303a4d8da6a56860f638e32a0fb3266c65e88e1`
is excluded by the common static floor; current authority is correction and
non-live reverification only.
