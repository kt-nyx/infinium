...
- the accepted [M1 backend semantic proof plan](../../plan.md)
  and its accepted
  [evaluator-v2 amendment](../../amendments/evaluator-v2.md);
...
- the accepted [development execution policy](../../../../../execution-policy.md);
...
Initial next package at the 2026-08-08 accepted revision: `M1/S5/WP2`

This plan is accepted implementation authority for its dependency-ordered work
packages. The historical 2026-08-08 handoff made `M1/S5/WP2` eligible after
WP1 review. Each later package remains
...
## Repository-normalization mapping

The accepted [pre-closeout normalization amendment](repository-normalization.md)
changes current repository names and paths without rewriting historical
records or source-authority identities. Current work applies this map:
...
Historical Git-bound paths, package identities, commands, and fixture
`source_authority` entries remain exact evidence of their original revisions.
In particular, the cross-stage corpus entries bound to revision `e7de030` are
resolved with `git cat-file`; they are not current navigation paths and must
not be rewritten.
...
11. `docs/plans/milestones/m1/slices/s5/record.md` records exact contracts,
...
- accepted [M1 evaluation baseline](../../../../../evaluation/m1-evaluation-baseline.md),
  ...
  [semantic fixture manifests](../../../../../evaluation/specifications/semantic-fixture-catalog.md),
  and [platform fixture manifests](../../../../../evaluation/specifications/platform-fixture-catalog.md);
...
- the current [Slice 5 implementation record](record.md).
...
`docs/plans/milestones/m1/slices/s5/record.md`; repository legacy/historical
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File eng/verify-analysis-pipeline.ps1 -Gate All -OutputRoot artifacts/analysis-pipeline/closeout
```
...
`docs/plans/milestones/m1/slices/s5/record.md` must contain:
