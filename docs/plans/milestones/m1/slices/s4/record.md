...
Slice 4.5 and made Slice 5 eligible. Later status is maintained only in
[current project state](../../../../../current-state.md). This Slice 4 record
claims only its exact public conformance scope—not
