...
builds reproduced the coordinator, helper, and complete 126-file execution
closure exactly.
The prior finite-campaign candidate
`38030a7ac2238c0d095942873b6425299040aaa7` is superseded by bounded
rehearsal-harness corrections. Current authority is correction and non-live
reverification only; no replacement candidate is yet bound for review. The
