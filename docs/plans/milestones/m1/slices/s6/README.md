...
builds reproduced the coordinator, helper, and complete 126-file execution
closure exactly.
Binding `0ab6835ee096032f763e766484cc9178199ce635` is excluded because one
credential close-ready identity remained stale. Current authority is
correction and non-live reverification only; no replacement candidate is yet
bound for review. The
