...
superseded pre-v2 canonical request shape. Current authority is correction and
non-live reverification only; no replacement candidate is bound. No authority
is inherited. The
