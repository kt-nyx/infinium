...
Predecessor: [M1 backend semantic proof revision 2](private-fixture-repository.md)
...
- Slice 4.5 is active under the accepted
  [execution plan](../../../../evaluation/evaluator-history.md).
...
[oracle-contract completion and held-out disposition plan](../../../../evaluation/evaluator-history.md).
