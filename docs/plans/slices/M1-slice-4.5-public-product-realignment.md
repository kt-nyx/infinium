...
- [authority-completion conformance mismatch](../../evaluation/m1-slice4-authority-completion-conformance-mismatch.md);
- [final held-out scope amendment](../../evaluation/m1-slice4-heldout-scope-final-amendment.md);
- [evaluator-v2 baseline amendment](../../evaluation/m1-evaluation-baseline-evaluator-v2-amendment.md);
- [parent Slice 4.5 plan](M1-slice-4.5-held-out-evaluation-v2.md);
- [Slice 4 implementation record](../implementation-records/M1-slice-4.md);
- [Slice 4.5 implementation record](../implementation-records/M1-slice-4.5.md);
