...
candidate at `98fe8a5` remains publicly verified against EVAL-0052 and the
applicable EVAL-0086 assertions. Evaluator-v1 produced no valid held-out
product verdict and is retired. The historical evaluator-v2 `/2` Stage C
