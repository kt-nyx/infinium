...
Public /5 successor: WP0 and WP1R complete; ADR-0031 successor model accepted; WP1 resumed
...
| EVAL-0016 | Real mods | Actor/AI/FaceGen cross-layer | First pinned real scope-incongruent reversion candidate (`REAL-NPC-0001`) | ANALYSIS-004, ANALYSIS-005 | Qualified candidate; Wave F specification accepted; execution pending |
| EVAL-0017 | Real mods | Placed-reference/link/placement cross-layer | Materially different generic-mechanism candidate (`REAL-REFR-0001`) | ANALYSIS-004, ANALYSIS-005 | Qualified candidate; Wave F specification accepted; execution pending |
...
| EVAL-0052 | Integration ground truth | Bethesda records | For positively allowlisted `Mutagen.Bethesda.Skyrim` `0.54.2` shapes, supported plugin order, records, override chains, winners, FormKeys, links, states, and field values agree with independently specified hand-audited binary/semantic fixture expectations; the Mutagen path under test is not the sole source of expected results, and unsupported archive/string/record semantics become explicit gaps | SCOPE-005, ANALYSIS-003, ANALYSIS-019, COVER-001 | Historical public Slice 4 evidence passed. ADR-0028 bound the initial mismatch and public realignment/requalification passed at frozen candidate `a98d648`. Pre-B2 WP1-WP5 completed and WP5 classified an evaluator `/4` representation gap. ADR-0030 authorized public `/5` successor qualification; ADR-0031 and WP1R accepted its distinct semantic model and exact FaceGen loose-availability gap after preserving the historical WP1 stop. WP1 resumed. Candidate realignment, private B2, held-out C2, and the overall Slice 4.5 gate remain pending separate authorization. |
