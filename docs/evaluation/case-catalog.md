...
| EVAL-0092 | Contract/integration/scale | Frontend result exploration | Summary/readiness or scope-limited status, supported-case and lead-only queues, finding/case/report details, evidence/provenance expansion, and focused-mod views preserve canonical truth, uncertainty, coverage, and gaps through bounded server-side filters/sorts/search/keyset pages; 100,000 synthetic summaries are virtualized without full-population transfer | PROD-003, PROD-004, UX-001, UX-002, UX-003, UX-004, OPS-005 | Phase C focused evidence now covers a generated FindingReport queue/detail consumer, canonical round-trip, hostile inert text, exact run/cursor ownership, a populated pre-publication migration that returns a typed unavailable projection gap, and a 100,000-summary bounded page; Checkpoint C and desktop evidence remain pending. |
| EVAL-0093 | Contract/integration failure | Review state, assumptions, targeted verification, and export | Revision-bound append-only dispositions, suppression, annotations, and assumptions survive concurrency/restart without rewriting analysis; carryover obeys causal/revision proof; targeted verification creates separately initiated scope-linked work without borrowing unrelated readiness; and local-private structured export records exact selection/provenance/privacy/source-policy decisions without mutating source objects | INTENT-004, INTENT-005, FIND-005, FIND-006, FIND-007, FIND-014, UX-005, OPS-002, OPS-003 | Independent Phase C focused evidence covers recursive request rejection, export lifecycle/recovery/source immutability, and the ADR-0038 targeted-verification vertical: generated C# begin/status/cancel/start/readback over the real named-pipe path; complete bounded preparation fields and independent member, dependency, analyzer, lifecycle, artifact, and terminal-gap pagination; bounded opaque terminal-gap cursors reject hostile, malformed, substituted, and stale continuation; schema-17 sealed lifecycle ordering preserves equal-timestamp causality and append-stable pages while binding owner kind/sequence/generation/fence/timestamp/event bytes/projection/summary; canonical finding/case identity-envelope signatures and producer/semantic/identity versions; an unseeded actual fresh-snapshot and separately owned semantic-acquisition producer path through production planning to completed `managed-analysis-v1` successor and lineage readback; dependency-closed scope and one correlation status per member; raw-name/path/form-key denial and no slot-only changed correlation; production-reachable proven-absence and qualified unsupported/inaccessible/malformed limited-gap denominators; valid ambiguous and missing-proof plans retained as inspectable non-startable `Invalidated` preparations with zero successor mutations; pre-mutation source signature/version/seal/proof/drift rejection with no partial start writes; global cross-family one-shot gestures with exact retry; immutable initiation and ADR-0022 reconciliation lineage; schema-17 zero/nonzero migration, projection rebuild, restart, backup/restore, interrupted rollback, and tamper rejection, including schema-16 closed-shape acquisition-event mutations with the accepted source schema and triggers intact. This is developer-owned conformance evidence in a candidate awaiting corrected Checkpoint C review; EVAL-0093 and Checkpoint C are not accepted by this implementation record. |
