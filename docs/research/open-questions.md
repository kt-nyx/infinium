...
The product baseline was accepted on 2026-07-25. The questions below remain
unanswered. The
[M0 research-foundation plan](../plans/milestones/M0-research-foundation.md) is
Accepted and sequences their investigation. Every item remains Not started
until its bounded investigation actually begins. No item has been answered for
the rewrite merely because the legacy code chose an approach.

| ID | Question | Decision enabled | Status |
|---|---|---|---|
| RQ-001 | How can Infinium obtain authoritative MO2 profile and effective VFS state? | MO2 integration ADR | Not started |
| RQ-002 | Does MO2 expose a current/last-selected profile reliably? | Profile selection behavior | Not started |
| RQ-003 | Which exact Skyrim SE runtime version is initially pinned, how is it detected, and how is support deliberately advanced? | Runtime support contract | Not started |
| RQ-004 | Which Mutagen capabilities and gaps apply to plugins, override chains, archives, strings, and target record families? | Bethesda semantic layer ADR | Not started |
| RQ-005 | Should LOOT be integrated through CLI, libloot, or another supported interface? | LOOT integration ADR | Not started |
| RQ-006 | Which xEdit functions provide unique automated value and supported invocation? | External-tool scope | Not started |
| RQ-007 | What metadata does MO2 retain about Nexus identity, source archives, FOMOD choices, hidden files, and manual changes? | Identity/FOMOD design | Not started |
...
| RQ-009 | Which Nexus policies constrain scraping, caching, redistribution, and public application registration? | Source and distribution policy | Not started |
...
| RQ-014 | Which fingerprint/dependency strategy proves installation-snapshot and cache validity without prohibitive IO? | Snapshot/cache ADR | Not started |
...
| RQ-026 | What licensing/distribution obligations apply to bundled helpers and external tools? | Packaging/licensing ADR | Not started |
...
| RQ-031 | Which source bytes, tool/model boundary outputs, and tool/model/executable versions may be retained legally and practically; which retained content may appear in each export sharing class; and what replay and redistribution guarantees follow? | Retention/replayability/export policy | Not started |
...
Research conclusions remain proposals until the relevant ADR is accepted.
