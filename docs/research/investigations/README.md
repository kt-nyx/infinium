...
| [RESEARCH-0058](RESEARCH-0058-targeted-verification-executable-architecture.md) | Completed; recommendation accepted | RQ-042 resolves targeted verification through accepted ADR-0038 and the accepted WP6 addendum: prepare-inspect-start with separately owned semantic evidence, typed cross-snapshot coverage, and a dependency-closed `managed-analysis-v1` successor; implementation remains pending |
