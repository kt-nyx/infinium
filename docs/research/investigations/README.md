...
| [RESEARCH-0051](RESEARCH-0051-skyrimse-secondary-root-and-mapper-inventory.md) | Completed; disposition pending | The exact Skyrim SE game plugin has no secondary Data root and only maps profile plugin/load-order controls outside Data; retain the empty mapper allowlist and review a conditional-positive EVAL-0051 amendment |
