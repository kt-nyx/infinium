...
| [RESEARCH-0058](RESEARCH-0058-targeted-verification-executable-architecture.md) | Completed; recommendation proposed | RQ-042 identifies a prepare-inspect-start architecture with separately owned semantic evidence, typed cross-snapshot coverage, and a dependency-closed `managed-analysis-v1` successor; ADR-0038 and the WP6 addendum await owner disposition |
