...
public static class PublicBethesdaOracleValidator
{
    public const string ArtifactId = "oracle/independent-byte-facts.json";
        ...
        IReadOnlyDictionary<string, RetainedArtifactSnapshot> oracleSnapshots)
    {
        ...
        ActiveJsonSchemaValidator.Validate(root, "bethesda-byte-oracle.v1.schema.json");
    ...
    public static string ComputeCanonicalFingerprint(JsonElement value)
    {
