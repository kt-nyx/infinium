...
generator for Bethesda semantic fixtures. It uses only .NET/BCL APIs and consumes no game,
...
```powershell
dotnet run --project fixtures/tooling/bethesda/Infinium.BethesdaFixtures.Generator.csproj -- generate --output artifacts/bethesda-fixture-staging --seed 3520260730
```
...
```powershell
dotnet run --project fixtures/tooling/bethesda/Infinium.BethesdaFixtures.Generator.csproj -- verify --seed 3520260730
```
...
```powershell
node fixtures/tooling/bethesda/snapshot-receipts.mjs
```
...
```powershell
python fixtures/tooling/bethesda/independent-review/build_taxonomy_projections.py `
...
```powershell
node fixtures/tooling/reseal-public-fixtures.mjs
```
