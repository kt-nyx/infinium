#!/usr/bin/env python3
"""Build Bethesda semantic oracle artifacts from two independent frozen-byte reports."""
...
def build(package: Path, reader_path: Path, manual_path: Path) -> None:
    ...
    supplemental = {
        ...
        "format_evidence": [
            {
                "artifact_id": "docs/evaluation/specifications/bethesda-byte-format-evidence-v1.md",
                "artifact_version": "1",
    ...
    states = {
        name: {
            ...
            "reason": (
                ...
                if (name == "observations" or (name == "invalid_inputs" and invalid)
                    or (name == "coverage_gaps" and gaps))
                else "No Bethesda semantic expectation is assigned to this collection."
            ),
        }
