...
def build(package: Path) -> None:
    ...
    if (
        ...
        != "accepted-bethesda-construction-manifest-and-retained-input-seals"
    ):
        raise ValueError(
    ...
    projection = {
        ...
        "source_artifacts": [
            {
                ...
                "byte_length": byte_oracle_path.stat().st_size,
            },
            {
        ...
        "subjects": subjects,
        "review_assertions": [
            "The sealed subject set exhaustively covers the accepted production taxonomy subject-ID contract for this package.",
...
def unsupported_canonical(fixture_id: str, record_fact_id: str) -> dict[str, Any]:
    ...
    return {
        ...
        "expected_assignments": [
            ...
            assignment("affected-game-system-or-content-area", "affected-area", "unsupported", "established", [gap], "The frozen allowlist gap establishes that the semantic extractor cannot determine affected-area semantics for this record family."),
