...
These tools author Bethesda semantic oracle evidence without using the
...
```powershell
$package = 'fixtures/public/bethesda/BETH-NPC-DEV'
$scratch = 'work/oracle-review'

python fixtures/tooling/bethesda/independent-review/bounded_raw_reader.py `
  $package "$scratch/BETH-NPC-DEV-reader.json"

& fixtures/tooling/bethesda/independent-review/manual_hex_audit.ps1 `
  -PackagePath $package `
  -OutputPath "$scratch/BETH-NPC-DEV-manual.json"

python fixtures/tooling/bethesda/independent-review/build_oracles.py `
  $package `
...
python fixtures/tooling/bethesda/independent-review/self_test.py
```
