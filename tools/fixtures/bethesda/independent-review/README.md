...
```powershell
$package = 'test-data/public-fixtures/bethesda/BETH-NPC-DEV'
$scratch = 'work/oracle-review'

python tools/fixtures/bethesda/independent-review/bounded_raw_reader.py `
  $package "$scratch/BETH-NPC-DEV-reader.json"

& tools/fixtures/bethesda/independent-review/manual_hex_audit.ps1 `
  -PackagePath $package `
  -OutputPath "$scratch/BETH-NPC-DEV-manual.json"

python tools/fixtures/bethesda/independent-review/build_oracles.py `
  $package `
...
python tools/fixtures/bethesda/independent-review/self_test.py
```
