...
```powershell
dotnet run --project tools/fixtures/bethesda/Infinium.BethesdaFixtures.Generator.csproj -- generate --output artifacts/bethesda-fixture-staging --seed 3520260730
```
...
```powershell
dotnet run --project tools/fixtures/bethesda/Infinium.BethesdaFixtures.Generator.csproj -- verify --seed 3520260730
```
...
```powershell
node tools/fixtures/bethesda/snapshot-receipts.mjs
```
...
```powershell
python tools/fixtures/bethesda/independent-review/build_taxonomy_projections.py `
...
```powershell
node tools/fixtures/reseal-public-fixtures.mjs
```
