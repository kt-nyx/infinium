...
internal static class Program
{
    ...
    private static string ReadOutput(string[] args)
    {
        ...
        return Path.Combine("test-data", "public-fixtures", "bethesda");
    }
}
    ...
    private sealed class PackageOutput
    {
            ...
            IReadOnlyList<Dictionary<string, object?>> scenarios)
        {
            Json("case-matrix.json", new
            {
                ...
                source_basis = "accepted-bethesda-scenario-inventory-and-retained-execution-inputs",
                cases = scenarios,
            });
        ...
        private static object EffectiveScanConfiguration(string fixtureId)
            => new
            {
                ...
                schema_version = "1",
                configuration_id = $"{fixtureId.ToLowerInvariant()}.bethesda-semantic-fixture",
                ...
                analyzers = new[]
                {
                    new
                    {
                        analyzer_id = "bethesda-semantic-extractor",
                        analyzer_version = "1",
