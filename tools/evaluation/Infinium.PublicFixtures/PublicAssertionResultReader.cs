...
public sealed record EvaluationAssertionResult(
    ...
    string ActualSchemaId,
    string OracleSchemaId,
    ContractVersion StateModelVersion,
    Sha256Fingerprint CanonicalComparisonFingerprint,
...
public static class PublicAssertionResultReader
{
    ...
    private static readonly HashSet<string> AssertionResultProperties = new(StringComparer.Ordinal)
    {
        ...
        "oracle_schema_id",
        "state_model_version",
        "canonical_comparison_fingerprint",
        "status",
        "actual_references",
    ...
    public static EvaluationAssertionResult Read(string path)
    {
        ...
        ActiveJsonSchemaValidator.Validate(root, "evaluation-assertion-result.v1.schema.json");
        ...
        return new EvaluationAssertionResult(
            ...
            assertionType,
            RequiredString(root, "actual_schema_id"),
            RequiredString(root, "oracle_schema_id"),
            ContractVersion.Parse(RequiredString(root, "state_model_version")),
            ParseFingerprint(root, "canonical_comparison_fingerprint"),
            status,
            actualReferences,
