...
const fixtures = [
  {
    relativeRoot: "test-data/evaluation/m1-platform/M1-PLAT-SLICE2-SUBSTRATE-v1",
    fixtureId: "M1-PLAT-SLICE2-SUBSTRATE-v1",
    version: "1.1.0",
    semanticTruthSha256: "57f629893406ccd8fa862199103a05c2cad442c1f0718c874a431660ef25d43e",
    platform: true,
    evaluationIds: ["EVAL-0032"],
  },
  {
    relativeRoot: "test-data/evaluation/m1-semantic/BETH-NPC-DEV",
  ...
  {
    relativeRoot: "test-data/evaluation/m1-semantic/BETH-REFR-DEV",
  ...
  {
    relativeRoot: "test-data/evaluation/m1-semantic/BETH-LIGHT-VAL",
  ...
  {
    relativeRoot: "test-data/evaluation/m1-semantic/BETH-MALFORMED-VAL",
  ...
  {
    relativeRoot: "test-data/evaluation/m1-semantic/BETH-UNSUPPORTED-VAL",
...
async function buildReplayDependencies(fixtureRoot, fixture) {
  ...
  const sourcePaths = ["tools/evaluation/reseal-current-public-fixtures.mjs"];
  if (!fixture.platform) {
    sourcePaths.push(
      "tools/evaluation/bethesda-fixtures/Program.cs",
...
async function buildRootExecutionInput(fixtureRoot, fixture) {
  ...
  const resealerSha256 = await fileSha256(
    path.join(repositoryRoot, "tools", "evaluation", "reseal-current-public-fixtures.mjs"),
  );
    ...
    : [
        {
          ...
          fingerprint: await fileSha256(
            path.join(repositoryRoot, "tools", "evaluation", "bethesda-fixtures", "Program.cs"),
          ),
        },
        { component_id: "current-public-fixture-resealer", version: "1.0.0", fingerprint: resealerSha256 },
      ];
